				...
				<nav className="navbar navbar-expand-lg">
					<div className="container-fluid">
						...
						<div className="nav-btn d-flex align-items-center">
							<button type="button" className="btn btn-secondary btn-wallet" onClick={wallectConnectAction}>{(localStorage.accountDetail) ? "Disconnect" : "Connect Wallet"}</button>
							<a href="https://discord.gg/xwB4S5Yhw3" target="_blank" className="btn btn-secondary btn-discord">
								<img loading="lazy" src={require("../assets/images/discord.png").default} alt="Discord logo" className="button-icon" />
